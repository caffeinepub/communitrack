import { r as reactExports, j as jsxRuntimeExports, E as EmptyState, g as getTierInfo, a as getTicketTierInfo, c as compactNumber, f as findMatchInMap, b as getColorForDelta } from "./index-s23PH5OY.js";
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { className: "text-[13px]", children: data.map((community, index) => {
      ...
      return /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "tr",
        {
          ...
          className: `border-b border-zinc-800/50 hover:bg-zinc-900 transition-colors animate-fadeIn focus:outline-none focus:bg-zinc-900 ${tier.bg} ${community.url ? "cursor-pointer" : ""}`,
          children: [
